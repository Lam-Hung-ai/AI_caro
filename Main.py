...
def minimax(Board: list, isMaximizing: bool, depth: int, alpha: int, beta: int, Score_Player: list, Score_AI: list, Score_Tong: list, Tplayer: dict, TAi: dict, TTong: dict, Map_Player: list, Map_AI: list, x: int = -1, y: int = -1) -> tuple[int, int]:
    '''
